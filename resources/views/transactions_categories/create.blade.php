...
@section('seo_title', 'Ajouter une catégorie')

@section('content')

    @include('part.page_title', ['title' => '<i class="fa fa-wrench mr-3"></i> Configuration > Catégories > Ajouter une catégorie'])
    ...
    <div class="max-w-xl">
        <form action="" method="POST">
            ...
            <select name="color" id="color" class="w-full block p-2 mt-2 text-sm rounded shadow border border-gray-300" >
